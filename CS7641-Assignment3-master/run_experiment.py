...
if __name__ == '__main__':
    ...
    dataset1_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.05],
                               'NN__hidden_layer_sizes': [(50,50,50)], 'NN__learning_rate_init': [0.001]}
        }
    dataset2_details = {
            'data': loader.Iris(verbose=verbose, seed=seed),
            'name': 'iris',
            'readable_name': 'Iris dataset',
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.05],
                               'NN__hidden_layer_sizes': [(50,50,50)], 'NN__learning_rate_init': [0.001]}
    }
